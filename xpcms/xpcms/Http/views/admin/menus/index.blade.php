    ...
    <table>
        ...
        @foreach($list as $item)
            <tr>
                ...
                <td>{{$item["action"]}}</td>
                <td>{!!$item["ishidden"]==0? 'NO':'<span style="color:red;">YES</span>'!!}</td>
                <td>{!!$item["status"]==0? 'NO':'<span style="color:red;">YES</span>'!!}</td>
                <td>
                    <!-- Button trigger modal -->
                    <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#myModal2" onclick="child({{$item['mid']}})">Sub Menu</button>
                    ...
                    <button onclick="del({{$item['mid']}})">Delete</button>
                </td>
            </tr>
        @endforeach
        </tbody>
